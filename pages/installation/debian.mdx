...
you can easily install and update LibreWolf. To add it to your system, you can
...
add it to your system with the following commands:
...
You can try to use the Ubuntu 20 build from the deb.librewolf.net repository by
...
This may or may not work, depending on how close your system is to Ubuntu 20. If
it doesn't work, you can always use
